<template>
  <div class="app-container">
    ...
    <el-row>
      ...
      &nbsp;
      <el-button @click="handleClick(inputData)"
    ...
    <el-row>
      ...
      >
        ...
        <el-table-column label="风险等级" prop="risk_level" align="center">
    ...
    handleClick(arr) {
      ...
      this.tableData = this.search.map((item) => {
        if (item < 35) {
          ...
          return this.options[parseInt(item / 100 - 1)].children[
            parseInt((item % 100) / 10 - 1)
          ].children[parseInt((item % 10) - 1)];
        }
      });
